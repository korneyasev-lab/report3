...
# ID чата куда отправлять (узнать у @userinfobot в Telegram)
TELEGRAM_CHAT_ID = ""

# Инструкция для пользователя
TELEGRAM_SETUP_INFO = """Для настройки Telegram бота:

1. Откройте Telegram и найдите @BotFather
2. Отправьте команду /newbot
3. Следуйте инструкциям и получите токен бота
4. Скопируйте токен в поле "Токен бота"

5. Найдите @userinfobot в Telegram  
6. Отправьте ему любое сообщение
7. Бот вернёт ваш Chat ID
8. Скопируйте Chat ID в поле "Chat ID"

9. Нажмите "Тест соединения" для проверки
"""